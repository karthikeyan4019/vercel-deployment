        ...
        {category?.map((value,index)=>
          {
            return(
               <>
                  ...
                  {/* <div id="card-home" onClick={()=>{navigate(`/SpecificProducts/${value.category}`)}}> */}
                  <div id="card-home" onClick={()=>{navigate(`/ProductsShow/${value.category}`)}}>
                   <img src={value.imagePath} alt={value.category}/>
                   <p className="category-text"><b>{value.category}</b></p>
                  </div>
               </>
             )
         })}
